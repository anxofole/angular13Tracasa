...
export class AppComponent {
  ...
  public onEnabledChanged(): void {
    this.selectedPerson = { ...this.selectedPerson!, enabled: !this.selectedPerson!.enabled };
    let selectedPersonIndex = this.people.findIndex(p => p.id == this.selectedPerson?.id);
